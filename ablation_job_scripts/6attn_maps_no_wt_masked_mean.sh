...
original_sbatch="/tudelft.net/staff-umbrella/StudentsCVlab/vchatalbasheva/Thesis-Splign/job_scripts/sd2.1_masked_mean_6attn_maps_no_wt_visor_ablation.sbatch"
...
for config in "${configs[@]}"; do
    ...
    for alpha in "${alpha_array[@]}"; do
        ...
        new_sbatch="${sbatch_files_dir}/sd2.1_masked_mean_${loss_type}_${loss_num}_${alpha}_visor_ablation.sbatch"
