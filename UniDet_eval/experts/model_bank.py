...
def load_expert_model(config, task=None, ckpt=None):
    if task == 'depth':
        ...
        if ckpt == "RS200":
            config.config_file = 'UniDet_eval/experts/obj_detection/configs/Unified_learned_OCIM_RS200_6x+2x.yaml'
            config.opts = ['MODEL.WEIGHTS', 'UniDet_eval/experts/expert_weights/Unified_learned_OCIM_RS200_6x+2x.pth']
        elif ckpt == "R50":
            config.config_file = 'UniDet_eval/experts/obj_detection/configs/Unified_learned_OCIM_R50_6x+2x.yaml'
            config.opts = ['MODEL.WEIGHTS', 'UniDet_eval/experts/expert_weights/Unified_learned_OCIM_R50_6x+2x.pth']
        else:
