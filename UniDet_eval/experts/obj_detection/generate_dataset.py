...
class Dataset(Dataset):
    def __init__(self, data_path, transform):
        ...
        data_images = data_path
        data_imgs = os.listdir(data_images)
        data_imgs = [x for x in data_imgs if ".png" in x] # put the labels inside the folder with images
        ...
        self.data_list = [os.path.join(data_images, data).replace("\\", "/") for data in data_imgs]
