...
original_sbatch="/tudelft.net/staff-umbrella/StudentsCVlab/vchatalbasheva/Thesis-Splign/job_scripts/sd1.4_leaky_relu_slope_visor_ablation.sbatch"
    ...
    for loss_num in "${loss_nums[@]}"; do
        for alpha in "${alpha_values[@]}"; do
            for slope in "${leaky_relu_slope[@]}"; do
                new_sbatch="${sbatch_files_dir}/sd1.4_${loss_type}_slope_${slope}_${loss_num}_${alpha}_6attn_no_wt_visor_ablation.sbatch"
